...
receiver_name = "LY1BWB"
receiver_location = "Vilnius, Lithuania"
receiver_asl = 200
receiver_admin = "ly1bwb@gmail.com"
#receiver_gps = {"lat": 54.686000, "lon": 25.2913900}
receiver_gps = {"lat": 54.731484, "lon": 25.2621000}
photo_title = ""
...
photo_desc = """
Receiver is operated by: <a href="mailto:ly1bwb at gmail.com" target="_blank">LY1BWB</a><br/>
Device: LimeSDR + MFJ-1708B-SDR + Preamp<br />
Antenna: 144 MHz Cross Yagi<br />
Website: <a href="http://ly1bwb.vhf.lt" target="_blank">http://ly1bwb.vhf.lt</a><br />
<a href="http://sdr.vhf.lt:5000/static/gfx/webcam.jpg" target="_blank">Webcam</a> (looking South)<br />
"""

#ANT Azimuth: <span id="rotator-azimuth" />&deg;<br />
#ANT Elevation: <span id="rotator-elevation" />&deg;<br />
...
#                "rf_gain": 29.7,
                "samp_rate": 1024000,
                "start_freq": 145825000,
                "start_mod": "nfm",
            },
            "2m-SAT": {
                "name": "2m SAT",
                "center_freq": 145850000,
                "rf_gain": 50,
                "samp_rate": 300000,
                "start_freq": 145825000,
                "start_mod": "nfm",
            ...
            "143 MHz": {
                "name": "143 MHz",
                "center_freq": 143010000,
#                "rf_gain": 32.8,
                "samp_rate": 256000,
                "start_freq": 143040000,
                "start_mod": "usb",
            },
#            "6m": {
#                "name": "6m",
#                "center_freq": 50450000,
#                "samp_rate": 900000,
#                "start_freq": 50000000,
#                "start_mod": "usb",
#            },
            "137 MHz NOAA": {
                ...
                "rf_gain": 50,
                "samp_rate": 1024000,
                "start_freq": 137912500,
                "start_mod": "nfm",
            },
            "Airband": {
                "name": "133 MHz air",
                "center_freq": 133000000,
                "rf_gain": 50,
                "samp_rate": 2400000,
                "start_freq": 133300000,
                "start_mod": "am",
            },
            "118 MHz": {
                "name": "118 MHz air",
...
#                "rf_gain": 29.7,
	...
	"device": "00000001",
        ...
        "profiles": {
            "430mhz": {
                "name": "430 MHz ",
                "center_freq": 430510000,
                "rf_gain": 29.7,
                "samp_rate": 1024000,
                "start_freq": 430650000,
                "start_mod": "nfm",
	    },
            "432mhz": {
                "name": "432 MHz ",
                "center_freq": 432400000,
                "rf_gain": 29.7,
                "samp_rate": 1024000,
            ...
            "434mhz": {
                "name": "434 MHz",
                "center_freq": 434400000,
                "rf_gain": 29.7,
                "samp_rate": 2048000,
                "start_freq": 434500000,
                "start_mod": "usb",
	    },
            "436mhz": {
                "name": "436 MHz",
                "center_freq": 436500000,
                "rf_gain": 29.7,
                "samp_rate": 2048000,
                "start_freq": 436500000,
                "start_mod": "usb",
	    },
            "438mhz": {
                "name": "438 MHz",
                "center_freq": 438600000,
                "rf_gain": 29.7,
                "samp_rate": 2048000,
                "start_freq": 438250000,
                "start_mod": "usb",
	    },
            "439mhz": {
                "name": "439 MHz",
                ...
                "rf_gain": 29.7,
                "samp_rate": 2048000,
                "start_freq": 439000000,
                "start_mod": "usb",
	    },
            "446mhz": {
                "name": "446 MHz PMR",
                "center_freq": 446140000,
                "rf_gain": 29.7,
#                "samp_rate": 1024000,
                "samp_rate": 300000,
            ...
            "401mhz": {
                "name": "401 MHz",
                "center_freq": 401000000,
                "rf_gain": 29.7,
                "samp_rate": 2048000,
                "start_freq": 401000000,
                "start_mod": "usb",
	    },
	},
    },
...
#services_decoders = ["ft8", "wspr"]
services_decoders = ["packet"]
services_decoders = ["packet", "ft8"]

# === aprs igate settings ===
# if you want to share your APRS decodes with the aprs network, configure these settings accordingly
aprs_callsign = "LY1BWB-1"
#aprs_igate_enabled = False
aprs_igate_enabled = True
aprs_igate_server = "euro.aprs2.net"
aprs_igate_password = "22971"
#aprs_baudrate = 300
...
pskreporter_callsign = "LY1BWB"
# optional antenna information, uncomment to enable
pskreporter_antenna_information = "144 MHz Cross Yagi [ly1bwb.vhf.lt]"
